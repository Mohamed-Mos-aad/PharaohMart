// ** Style
import style from "../../style/components/ui/toggleElement.module.css";
// ** Hooks && Tools
  ...
  return (
    <>
      <div className={style.toggle_input_element} {...rest}>
        <h3>{title}</h3>
        <div
          className={`${style.toggle_element} ${
            inputToggle && style.toggle_element_true
          }`}
          onClick={changeToggleStateHandler}
        >
          <span></span>
        </div>
      </div>
