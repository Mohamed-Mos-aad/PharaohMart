...
import DropTextElement from "../../components/ui/DropTextElement";
        ...
        <div className={style.help}>
          ...
          <section>
            ...
            <DropTextElement
              ...
              description="To list an item, go to your seller dashboard and click 'Add New Listing'. Fill in all the required details, including item description, price, and shipping information. You can also add photos and videos to showcase your product. "
            />
            <DropTextElement
              title="What are the fees for selling on Crafty?"
              description="We operate with a clear and transparent fee structure. A percentage fee of [percentage, e.g., 10%] of the sale price is charged on each transaction, plus a fixed fee of [amount, e.g., $2] per sale. Additional fees may apply for premium services or promotions. You can find detailed information about our fees in the Seller Dashboard under the Fees section. Our aim is to offer an affordable platform that helps you maximize your profits. "
            />
            <DropTextElement
              title="How do I handle returns and refunds?"
