        ...
        <>
            <div className="dashboard_container">
                <div className={style.setting}>
                    ...
                    <InputElement error='' id="storeName" label="Store Name" name="storeName" placeholder="Enter Store Name" type="text" onChange={()=>{}}/>
                    ...
                    <section>
                        ...
                        <div className={style.inputs_row}>
                            <InputElement error='' id="storeEmail" label="Email" name="storeEmail" placeholder="Enter Email" type="text" onChange={()=>{}}/>
                            <InputElement error='' id="storePhone" label="Phone" name="storePhone" placeholder="Enter Phone" type="text" onChange={()=>{}}/>
                        </div>
                    </section>
                    <section>
                        <h3>Store Address</h3>
                        <InputElement error='' id="storeAddress" label="Address" name="storeAddress" placeholder="Enter Address" type="text" onChange={()=>{}}/>
                    </section>
                    <section>
                        <h3>Service Zones</h3>
                        <InputElement error='' id="StoreServiceZones" label="Service Zones" name="storeServiceZones" placeholder="Enter Service Zones" type="text" onChange={()=>{}}/>
                    </section>
                    <section>
                        <h3>Return Policy</h3>
