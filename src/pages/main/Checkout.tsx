            ...
            <div className="global_container">
                <div className={style.checkout}>
                    ...
                    <div className={style.paymentMethod}>
                        <div className={style.inputs_row} onClick={()=>{selectPaymentMethod('card')}}>
                            {
                                checkedMethod === 'card' ?
                        ...
                        <div className={style.inputs_row} onClick={()=>{selectPaymentMethod('payPal')}}>
                            {
                        ...
                        <div className={style.inputs_row} onClick={()=>{selectPaymentMethod('cash')}}>
                            {
                                checkedMethod === 'cash' ?
                                    <img src={checkedRadioIcon} alt="Checked radio icon" />
                                :
                    ...
                    <h3>Total<span>${totalAmount.toFixed(2)}</span></h3>
